// Footer Component
// Generated: 2025-08-29T12:10:06.846Z
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                Build faster, scale smarter, and innovate with confidence using our minimal yet powerful platform.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@minimaltech.dev</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
